<!-- This is a header component, this component is included in adminlayout -->
<template>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <PopoverGroup as="nav" class="hidden md:flex space-x-10">
          ...
          <a href="/list-seller" class="text-base font-medium text-gray-500 hover:text-gray-900">
            Sellers
          </a>
          <a href="/list-customer" class="text-base font-medium text-gray-500 hover:text-gray-900">
            Customers
          </a>
        ...
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
          <a href="/user/profile" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          ...
          <div class="py-6 px-5 space-y-6">
            <div class="grid grid-cols-2 gap-y-4 gap-x-8">
              <a href="/list-seller" class="text-base font-medium text-gray-900 hover:text-gray-700">
                Sellers
              </a>

              <a href="/list-customer" class="text-base font-medium text-gray-900 hover:text-gray-700">
                Customers
              </a>
            ...
            <div>
              <a href="/user/profile" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                {{ $page.props.user.name }}
              </a>
...
const solutions = [
  ...
  {
    name: 'List Brands',
    description: 'See the brands which you have already created.',
    href: '/list-brand',
    icon: ChartBarIcon,
  },
  ...
  {
    name: 'Add Brand',
    description: 'Add a new brand for your products.',
    href: '/create-brand',
...
const resources = [
  {
    name: 'List Products',
    description: 'List all the products you have in your store.',
    href: '/list',
    icon: SupportIcon,
  },
  {
    name: 'Add Product',
    description: 'Add a newly brought product to your store.',
    href: '/create-product',
